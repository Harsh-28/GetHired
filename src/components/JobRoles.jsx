  ...
  return (
    <div className="flex flex-wrap gap-4 min-h-screen flex-col">
      <div className="flex gap-x-16 gap-y-10 flex-wrap justify-center items-center">
        {jobs.map(jobs => (
          <div key={jobs._id} className="w-[390px] h-[200px] glassmorphism rounded-xl bg-opacity-15 overflow-hidden flex flex-col justify-center items-center text-white gap-3 border-[1px] text-[14px]">
            <h2 className="flex justify-center text-[20px]">{jobs.company}</h2>
            <p>Tittle: {jobs.title}</p>
